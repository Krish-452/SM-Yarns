  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}>
      ...
      <section className="py-28 px-6 bg-[#0A0A0A]">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
          <Reveal direction="left">
            <div className="p-10 rounded-3xl border border-white/5" style={{ background: 'linear-gradient(135deg, rgba(185,28,28,0.08) 0%, #141414 100%)' }}>
